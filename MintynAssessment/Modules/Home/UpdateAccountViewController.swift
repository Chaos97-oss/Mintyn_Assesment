...
class UpdateAccountViewController: FeatureBaseViewController {
    init() { super.init(title: "Update Account", icon: "info.circle.fill") }
    required init?(coder: NSCoder) { fatalError("init(coder:) has not been implemented") }
    override func viewDidLoad() {
        super.viewDidLoad()
        let desc = UILabel()
        desc.text = "Upgrade your Tier limits."
